var environment=1; //0表示测试环境 1:线上环境
var dialog={};
var ReqUrl={
    GoodsReqUrl:function () {
        return (environment==0?"http://127.0.0.1:8084/api/":"http://192.168.40.130:8084/api/");
    },
    OrdeReqUrl:function () {
        return (environment==0?"http://127.0.0.1:8086/api/":"http://192.168.40.130:8086/api/");
    },
    LoginReqUrl:function() {
        return (environment==0?"http://127.0.0.1:8082/api/":"http://192.168.40.130:8082/api/");
    },
    PayReqUrl:function () {
        return (environment==0?"http://127.0.0.1:8088/api/":"http://192.168.40.130:8088/api/");
    }
};
//设置cookie
